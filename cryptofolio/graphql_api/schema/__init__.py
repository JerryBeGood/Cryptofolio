...
from cryptofolio.graphql_api.schema.exchange import exchange_type_defs, exchange_mutation

# Initialization of the shcema
schema = make_executable_schema(
    [coingeko_typ_defs, binance_type_defs,
        user_account_type_defs, exchange_type_defs],
    [coingeko_query, binance_query, user_account_mutation, exchange_mutation])
